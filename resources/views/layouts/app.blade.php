...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 mx-4">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <span class="dark:text-white">v {{ \Riomigal\Languages\LanguagesServiceProvider::$version  }}</span>
        ...
        @if(auth(config('languages.translator_guard'))->check())
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
                        <a href="{{ route('languages.languages') }}"
                    ...
                    <li>
                        <a href="{{ route('languages.manual') }}"
                           class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{{ __('languages::navbar.manual') }}</a>
                    </li>
                    ...
                    @endif
                    <li>
                        <form method="POST" action="{{route('languages.logout')}}">
                            @csrf
                            <button
                                class="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{{ __('languages::navbar.logout') }}</button>
                        </form>
                    </li>
                </ul>
            </div>

...
Route::middleware(['laravel-languages-auth-api'])->prefix('api')->group(function() {
    Route::post('cancelJobs', [LanguagesController::class, 'cancelBatch'])->name('languages.api.cancel-batch');
...
Route::prefix('api')->get('version', function() {
    return response()->json(
        ['version' => \Riomigal\Languages\LanguagesServiceProvider::$version]
    );
})->name('languages.api.version');
